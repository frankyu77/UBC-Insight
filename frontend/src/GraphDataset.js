...
function GraphDataset() {
    ...
    const handleFails = async (event) => {
        ...
        const query = "{ \"WHERE\": { \"AND\": [ { \"NOT\": { \"EQ\": { \"sections_year\": 1900 } } }, { \"GT\": { \"sections_fail\": 50 } } ] }, \"OPTIONS\": { \"COLUMNS\": [ \"sections_dept\", \"sections_year\", \"sumFail\" ], \"ORDER\": { \"dir\": \"UP\", \"keys\": [ \"sections_year\", \"sumFail\" ] } }, \"TRANSFORMATIONS\": { \"GROUP\": [ \"sections_dept\", \"sections_year\" ], \"APPLY\": [ { \"sumFail\": { \"SUM\": \"sections_fail\" } } ] } }";
        try {
            const response = await fetch(`http://localhost:4321/query`, {
                method: 'POST',
                headers: {
